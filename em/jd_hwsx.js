...
[task_local]
#京东众筹
0 8 * * * jd_hwsx.js, tag=京东众筹, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "0 8 * * *" script-path=jd_hwsx.js,tag=京东众筹

===============Surge=================
京东众筹 = type=cron,cronexp="0 8 * * *",wake-system=1,timeout=3600,script-path=jd_hwsx.js

============小火箭=========
京东众筹 = type=cron,script-path=jd_hwsx.js, cronexpr="0 8 * * *", timeout=3600, enable=true
*/
