...
[task_local]
#燃动夏季助力
0 0 * * * jd_summer_movement_help.js, tag=燃动夏季助力, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "0 0 * * *" script-path=jd_summer_movement_help.js,tag=燃动夏季助力

===============Surge=================
燃动夏季助力 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path=jd_summer_movement_help.js

============小火箭=========
燃动夏季助力 = type=cron,script-path=jd_summer_movement_help.js, cronexpr="0 0 * * *", timeout=3600, enable=true
...
*/
const $ = new Env('燃动夏季');
const MovementFaker = require('./jsNO1_e_MovementFaker.js')
