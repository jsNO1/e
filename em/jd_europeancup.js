...
[task_local]
#欧洲狂欢杯
0 7 * * * jd_cfd.js, tag=欧洲狂欢杯, jd_europeancup.js, tag=欧洲狂欢杯, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "0 7 * * *" script-path=jd_europeancup.js,tag=欧洲狂欢杯

===============Surge=================
欧洲狂欢杯 = type=cron,cronexp="0 7 * * *",wake-system=1,timeout=3600,script-path=jd_europeancup.js

============小火箭=========
欧洲狂欢杯 = type=cron,script-path=jd_europeancup.js, cronexpr="0 7 * * *", timeout=3600, enable=true
*/
const $ = new Env('狂欢欧洲杯');
