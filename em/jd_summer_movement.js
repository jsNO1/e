...
[task_local]
#燃动夏季
0 0 * * * jd_summer_movement.js, tag=燃动夏季, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "0 0 * * *" script-path=jd_summer_movement_help.js,tag=燃动夏季

===============Surge=================
燃动夏季 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path=jd_summer_movement.js

============小火箭=========
燃动夏季 = type=cron,script-path=jd_summer_movement.js, cronexpr="0 0 * * *", timeout=3600, enable=true
