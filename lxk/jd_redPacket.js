...
!(async() = > {
	...
	let _0x254699 = await _0x2b599c['WDhXz'](getAuthorShareCode, 'https://raw.githubusercontent.com/gitupdate/updateTeam/master/shareCodes/jd_red.json'), _0x49dd90 = await _0x2b599c[_0x5c3d('18', 'sEZ[')](getAuthorShareCode, _0x5c3d('19', '(S7p'));
	if (!_0x254699) _0x254699 = await _0x2b599c[_0x5c3d('1a', 'm0Q1')](getAuthorShareCode);
	...
	for (let _0xd83cb6 = 0x0; _0x2b599c[_0x5c3d('1c', 'dECe')](_0xd83cb6, cookiesArr[_0x5c3d('1d', 'qi!x')]); _0xd83cb6++) {
		if (cookiesArr[_0xd83cb6]) {
			...
			$[_0x5c3d('21', 'QeIx')] = '';
			await TotalBean();
			console[_0x5c3d('22', 'I($f')](_0x5c3d('23', 'm0Q1') + $[_0x5c3d('24', 'pqb(')] + '】' + ($[_0x5c3d('25', 'qi!x')] || $['UserName']) + '****
');
			if (!$[_0x5c3d('26', 'wc[h')]) {
				$['msg']($[_0x5c3d('27', '$[C2')], _0x5c3d('28', 'lR53'), _0x5c3d('29', 'GEp&') + $[_0x5c3d('2a', 'Jnb7')] + ' ' + ($['nickName'] || $['UserName']) + _0x5c3d('2b', ']loZ'), {
					'open-url': 'https://bean.m.jd.com/bean/signIndex.action'
				});
				if ($['isNode']()) {
					await notify['sendNotify']($['name'] + _0x5c3d('2c', 's%P1') + $[_0x5c3d('2d', '$lyO')], _0x5c3d('2e', 'KKA&') + $[_0x5c3d('2f', 'lR53')] + ' ' + $['UserName'] + _0x5c3d('30', ']G5@'));
				}
				continue;
			}
			$[_0x5c3d('31', '#g!5')] = 0x0;
	...
	for (let _0x108dc3 = 0x0; _0x2b599c['Wxsdm'](_0x108dc3, cookiesArr[_0x5c3d('33', 'pqb(')]); _0x108dc3++) {
		...
		if (cookiesArr && cookiesArr[_0x5c3d('39', 'oaTe')] > 0x2) {
			...
			for (let _0x5c5ad1 of $[_0x5c3d('3c', 'f$@p')]) {
				console[_0x5c3d('3d', 'J(]D')](_0x5c3d('3e', 'oaTe') + $[_0x5c3d('3f', 'I($f')] + ' ' + $[_0x5c3d('40', 'o%Hs')] + _0x5c3d('41', '8ye]') + _0x5c5ad1 + _0x5c3d('42', '$[C2'));
...
// 				console[_0x5c3d('4a', 'inWv')]('
// 账号 ' + $[_0x5c3d('4b', 'qi!x')] + ' ' + $[_0x5c3d('4c', 'afg[')] + ' 开始给作者 ' + _0x3f5aaf + _0x5c3d('4d', 's2t@'));
...
// 		}
	...
	$['log']('', '❌ ' + $['name'] + _0x5c3d('52', 'GEp&') + _0x598b1d + '!', '');
})['finally'](() = > {
	$[_0x5c3d('53', 'RJ[D')]();
});
async
...
function showMsg() {
	console[_0x5c3d('62', 'oaTe')]('

' + $[_0x5c3d('63', 'XpI[')] + _0x5c3d('64', 'J(]D') + $[_0x5c3d('65', 'GEp&')] + _0x5c3d('66', 'o7vD'));
}
async
function doLuckDrawFun() {
	var _0x1678ca = {
							...
							if (_0x2d8ba8[_0x5c3d('8b', 'o%Hs')](_0x2d8ba8[_0x5c3d('8c', 'afg[')], _0x2d8ba8[_0x5c3d('8d', 'Jnb7')])) {
								...
								if (_0x2d8ba8['mLXhv'](_0x41b7f['code'], '0') && _0x41b7f['busiCode'] === '0') {
									if (_0x2d8ba8[_0x5c3d('8f', 'GR%&')] !== _0x2d8ba8['BCqMn']) {
										...
										console['log']('
' + $[_0x5c3d('a4', 'qi!x')] + _0x5c3d('a5', 'f$@p'));
										console['log'](JSON[_0x5c3d('a6', 'piza')](_0x446f01));
									}
								}
							} else {
								console[_0x5c3d('a7', 'GR%&')]('
' + $['name'] + ': API查询请求失败 ‼️‼️');
				...
				console[_0x5c3d('22', 'I($f')]('

' + $[_0x5c3d('ab', 'P3j6')] + _0x5c3d('ac', 'piza') + $['discount'] + _0x5c3d('ad', '4%Cg'));
			}
		});
	});
}
	...
	if ($['taskHomePageData'] && _0x3b27d9[_0x5c3d('b3', 'OghG')]($[_0x5c3d('b4', 'dECe')][_0x5c3d('b5', 'n@nG')], 0x0)) {
		...
		if ($[_0x5c3d('ba', ']loZ')] && _0x3b27d9['ebjCO']($[_0x5c3d('bb', '@YZ@')][_0x5c3d('bc', '(S7p')], 0x0)) {
			if (_0x3b27d9[_0x5c3d('bd', 'oaTe')](_0x3b27d9[_0x5c3d('be', '(S7p')], _0x3b27d9[_0x5c3d('bf', 'GR%&')])) {
				...
				console[_0x5c3d('c0', 's2t@')]('    任务     状态  红包是否领取');
				for (let _0x2c246a of $['taskInfo']) {
					console['log'](_0x2c246a['title']['slice'](-0x6) + '   ' + (_0x2c246a[_0x5c3d('c1', 'GEp&')] ? _0x2c246a['alreadyReceivedCount'] : 0x0) + '/' + _0x2c246a[_0x5c3d('c2', '4%Cg')] + _0x5c3d('c3', '8ye]') + (_0x2c246a[_0x5c3d('c4', '$[C2')] === 0x4 ? '是' : '否'));
				}
					...
					if (_0x3b27d9['BYFcq'](_0x9c974d[_0x5c3d('c6', 'fCgc')], 0x4)) {
						...
						if (_0x3b27d9['wrkWS'](_0x9c974d[_0x5c3d('ed', 'qt1B')], 0x0) && _0x3b27d9[_0x5c3d('ee', ']G5@')](_0x9c974d[_0x5c3d('ef', '$[C2')], 0x1)) {
							...
							if (_0x3b27d9['AxCVO'](_0x3b27d9[_0x5c3d('fd', 'Vm#Z')], _0x3b27d9[_0x5c3d('fe', '4%Cg')])) {
								...
								console['log']('[' + _0x9c974d[_0x5c3d('100', 'Jnb7')] + '] 功能未开发');
							}
						}
					}
				}
		...
		console['log'](_0x5c3d('101', 'J(]D') + JSON['stringify']($[_0x5c3d('102', 'pqb(')]) + '
');
	}
}
async
...
当前待拆红包ID:' + $['h5activityIndex'][_0xf8d4f2[_0x5c3d('132', 'P3j6')]][_0xf8d4f2['pevEv']][_0xf8d4f2[_0x5c3d('133', 'SI!Z')]]['id'] + '，进度：再邀' + $[_0x5c3d('134', 'Jnb7')][_0xf8d4f2[_0x5c3d('135', 's2t@')]][_0xf8d4f2['pevEv']][_0xf8d4f2[_0x5c3d('136', 'lR53')]] + _0x5c3d('137', ')4(@') + ($['hasSendNumber'] + 0x1) + '个红包。当前已拆红包：' + $[_0x5c3d('138', 'afg[')] + _0x5c3d('139', 'qi!x') + $['h5activityIndex'][_0xf8d4f2[_0x5c3d('13a', '(S7p')]][_0x5c3d('13b', ')4(@')]['remainRedpacketNumber'] + _0x5c3d('13c', 'qt1B') + $[_0x5c3d('13d', ']loZ')] + '好友助力
...
');
		...
		if ('qVBZh' !== _0xf8d4f2[_0x5c3d('158', 'fCgc')]) {
			console[_0x5c3d('159', '$[C2')]('
' + $[_0x5c3d('15a', 'sEZ[')][_0x5c3d('15b', 'OghG')][_0xf8d4f2['tSMtB']] + '
');
		} else {
			if (err) {
				console[_0x5c3d('15c', 'OghG')]('
' + $[_0x5c3d('15d', '$lyO')] + _0x5c3d('15e', 'SI!Z'));
...
function taskHomePage() {
	...
	return new Promise(_0x58f1a5 = > {
		...
		if (_0x18f4cb[_0x5c3d('166', 'QeIx')](_0x18f4cb[_0x5c3d('167', 'oaTe')], _0x18f4cb['JmYGW'])) {
			$[_0x5c3d('168', 'wc[h')](_0x18f4cb[_0x5c3d('169', 'o7vD')](taskUrl, arguments['callee'][_0x5c3d('16a', 'o%Hs')][_0x5c3d('16b', 'DI]G')](), {
				'clientInfo': {}
						...
						if (_0x18f4cb[_0x5c3d('16e', 'qi!x')](_0x18f4cb[_0x5c3d('16f', 'fCgc')], _0x18f4cb[_0x5c3d('170', '(S7p')])) {
							...
							if (_0x1c6bdd) {
								if (_0x18f4cb[_0x5c3d('176', '1xX6')](_0x18f4cb[_0x5c3d('177', 'wc[h')], 'jIvjU')) {
									console[_0x5c3d('178', '$lyO')]('
' + $[_0x5c3d('16', 'dECe')] + _0x5c3d('179', ']G5@'));
			...
			console[_0x5c3d('80', 'qt1B')]('
' + $[_0x5c3d('196', 'lR53')] + _0x5c3d('197', 's2t@'));
			...
			$[_0x5c3d('1a3', 'NJq]')](taskUrl(arguments['callee'][_0x5c3d('1a4', '#g!5')][_0x5c3d('1a5', '7De#')](), _0x3d654a), (_0x1f5a73, _0x1d7290, _0x3d654a) = > {
				try {
					if (_0x20180a[_0x5c3d('1a6', '$[C2')]('sfeuv', _0x20180a['ohdvi'])) {
						...
						if (_0x1f5a73) {
							console[_0x5c3d('1a7', 'm0Q1')]('
' + $[_0x5c3d('1a8', 'I($f')] + _0x5c3d('1a9', 'afg['));
					...
					if (_0x20180a[_0x5c3d('1ac', 'GR%&')](_0x20180a[_0x5c3d('1ad', 'KKA&')], _0x20180a[_0x5c3d('1ae', 'p4$W')])) {
						...
						console[_0x5c3d('f4', 'fCgc')]('发起助力红包 失败：' + JSON['stringify'](_0x3d654a));
					}
				}
			});
		}
...
function active(_0x2bea66) {
	...
	if (_0x39c8d9 && _0x353a1a[_0x5c3d('1b4', 'Jnb7')](_0x39c8d9[_0x5c3d('1b5', ')4(@')], 0x0)) {
		...
		if (_0x353a1a[_0x5c3d('1c7', ']loZ')](_0x353a1a[_0x5c3d('1c8', 'GR%&')], _0x5c3d('1c9', 's%P1'))) {
			...
			console[_0x5c3d('1cc', ')4(@')]('
' + $['name'] + _0x5c3d('1cd', 'qt1B'));
				...
				if (_0x2682ae[_0x5c3d('1d8', '7De#')] === _0x2682ae[_0x5c3d('1d9', 'Ykax')]) {
					try {
						if (_0x2682ae[_0x5c3d('1da', 'qi!x')](_0x2682ae['znQly'], _0x2682ae['ejnGm'])) {
							if (_0x167487) {
								console[_0x5c3d('80', 'qt1B')]('
' + $[_0x5c3d('1db', ']loZ')] + _0x5c3d('1dc', 'dECe'));
...
' + $[_0x5c3d('1de', 'sEZ[')] + ': API查询请求失败 ‼️‼️');
						...
						if (_0x5c3d('1e6', 'm)@n') !== _0x5c3d('1e7', '(S7p')) {
							...
							console['log']('[' + item[_0x5c3d('f6', 'GR%&')] + '] 已经领取奖励');
						}
					}
				} else {
					console[_0x5c3d('1e9', 'qi!x')]('
' + $[_0x5c3d('1ea', 'KKA&')] + ': API查询请求失败 ‼️‼️');
		...
		if (_0x425c25['hOFqU'] !== _0x425c25[_0x5c3d('1f8', 's%P1')]) {
			$[_0x5c3d('1f9', 'p4$W')](_0x425c25['RHfJb'](taskUrl, arguments[_0x5c3d('1fa', 'Jnb7')][_0x5c3d('1fb', 'm0Q1')][_0x5c3d('1fc', 'QeIx')](), _0x1e84f5), (_0x99f409, _0x27df77, _0x1e84f5) = > {
				...
				if (_0x425c25[_0x5c3d('1fd', 'QeIx')](_0x5c3d('1fe', 'qi!x'), _0x425c25[_0x5c3d('1ff', 'inWv')])) {
					if (_0x99f409) {
						console['log']('
' + $[_0x5c3d('200', 'DI]G')] + _0x5c3d('201', 'Ykax'));
						...
						if (_0x1e84f5[_0x5c3d('10f', 'SI!Z')][_0x5c3d('204', 'KKA&')] && _0x1e84f5[_0x5c3d('205', '@YZ@')]['biz_code'] === 0x0) {
							console[_0x5c3d('206', 'afg[')](_0x5c3d('207', 'n@nG') + _0x1e84f5[_0x5c3d('84', 'm0Q1')][_0x5c3d('92', '$lyO')][_0x5c3d('208', 's%P1')] + '元
');
					...
					try {
						if (_0x99f409) {
							if (_0x425c25[_0x5c3d('20e', 'RJ[D')](_0x425c25[_0x5c3d('20f', '(S7p')], 'RVLzD')) {
								console[_0x5c3d('210', 'P3j6')]('
' + $[_0x5c3d('211', 'SI!Z')] + _0x5c3d('1a9', 'afg['));
			...
			console[_0x5c3d('1cc', ')4(@')]('红包领取成功，获得' + _0x1e84f5['data'][_0x5c3d('13b', ')4(@')][_0x5c3d('21f', 'Jnb7')] + '元
');
				...
				try {
					if (_0x1da607) {
						if (_0x294ead['tlBXJ'](_0x294ead[_0x5c3d('233', 'I($f')], _0x294ead[_0x5c3d('234', 'SI!Z')])) {
							...
							console[_0x5c3d('f0', 'dECe')]('
' + $[_0x5c3d('238', ')4(@')] + _0x5c3d('1dc', 'dECe'));
						...
						if (_0x51b3e3[_0x5c3d('23b', '96*f')][_0x5c3d('23c', 'o7vD')] && _0x294ead[_0x5c3d('23d', 'QeIx')](_0x51b3e3['data']['biz_code'], 0x0)) {
							if (_0x294ead[_0x5c3d('23e', 'P3j6')] !== _0x294ead[_0x5c3d('23f', '7De#')]) {
								console[_0x5c3d('240', 'sEZ[')](_0x5c3d('241', 'GR%&') + _0x51b3e3[_0x5c3d('242', 'NJq]')][_0x5c3d('13b', ')4(@')][_0x5c3d('243', 'dECe')] + '元
');
								$['discount'] += Number(_0x51b3e3[_0x5c3d('d6', 's%P1')]['result']['discount']);
							} else {
								console[_0x5c3d('210', 'P3j6')]('

发起助力红包 失败：' + _0x51b3e3[_0x496324[_0x5c3d('244', 'dECe')]][_0x5c3d('245', 's%P1')][_0x496324['eXkGV']]);
							}
						}
					}
				} catch (_0x3b76f5) {
				...
				console[_0x5c3d('246', 'p4$W')](_0x5c3d('247', 'afg[') + JSON[_0x5c3d('248', 'QeIx')]($['taskHomePageData']) + '
');
			}
		});
	});
...
' + $['name'] + ': API查询请求失败 ‼️‼️');
					...
					if (_0x3ca517[_0x5c3d('27a', 'KKA&')](_0x5c3d('27b', ']loZ'), _0x3ca517['UJShO'])) {
						console[_0x5c3d('202', 'Vm#Z')]('
' + $[_0x5c3d('27c', '7De#')] + _0x5c3d('27d', 'DI]G'));
		...
		$[_0x5c3d('292', 'I($f')](_0x2ec437, (_0x3ef482, _0x554b2c, _0x3b7254) = > {
			...
			try {
				if (_0x57afad[_0x5c3d('294', 'KKA&')](_0x5c3d('295', 'piza'), _0x5c3d('296', 'qi!x'))) {
					$[_0x5c3d('297', '(S7p')]($[_0x5c3d('298', 'Vm#Z')], _0x10cd55[_0x5c3d('299', 'J(]D')], _0x10cd55[_0x5c3d('29a', '8ye]')], {
						'open-url': _0x10cd55['cwTpi']
					});
					return;
				} else {
					if (_0x3ef482) {
						console[_0x5c3d('29b', '8ye]')]('
' + $['name'] + _0x5c3d('29c', '$lyO'));
						...
						if (_0x57afad[_0x5c3d('29e', '$[C2')] === _0x57afad[_0x5c3d('29f', 'pqb(')]) {
							...
							console[_0x5c3d('2b0', 'XpI[')]('
' + $[_0x5c3d('2b1', 'p4$W')]['data'][_0x10cd55[_0x5c3d('2b2', 'lR53')]] + '
');
						}
					}
				}
...
function h5launch() {
	...
	return new Promise(_0x1a5a6b = > {
		...
		$['post'](_0x1367bf, (_0x2fefe9, _0x4be56c, _0xad8b82) = > {
			try {
				if (_0x2fefe9) {
					console[_0x5c3d('2c4', 'f$@p')]('
' + $[_0x5c3d('2c5', 'OghG')] + _0x5c3d('2c6', 'QeIx'));
				...
				if ('gjTgV' !== _0x8f78f1['aZJTi']) {
					return {
						...
						'headers': {
							...
							'Accept': '*/*',
							'User-Agent': $['isNode']() ? process['env'][_0x5c3d('2e6', 'Ykax')] ? process['env'][_0x5c3d('2e6', 'Ykax')] : _0x1dec42['orAXH'](require, _0x5c3d('2e7', 'KKA&'))[_0x5c3d('2e8', '#g!5')] : $['getdata'](_0x5c3d('2e9', '96*f')) ? $[_0x5c3d('2ea', 'p4$W')]('JDUA') : 'jdapp;iPhone;9.4.4;14.3;network/4g;Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
...
async
function doAppTask(_0x5dc9db = '1') {
	var _0x24594b = {
			...
			if (_0x1f300a['PndHZ'](_0x1f300a[_0x5c3d('36d', 'pqb(')], _0x5c3d('36e', 'fCgc'))) {
				try {
					if (_0x77d0b0) {
						...
						console['log']($[_0x5c3d('250', 'o7vD')] + ' API请求失败，请检查网路重试');
					} else {
						if (_0x395ac5) {
...
function getAuthorShareCode(_0x353afa = _0x5c3d('37d', 'o%Hs')) {
	var _0xc12a3c = {
		...
		'hsAMY': _0x5c3d('37e', ']G5@'),
		'SNqTL': _0x5c3d('37f', 'Jnb7'),
		'SILaA': _0x5c3d('380', 'oaTe'),
		'bAway': _0x5c3d('381', '8ye]'),
	...
	return new Promise(_0xa212ba = > {
		var _0x369d0e = {
			'jZHSQ': function(_0x77e22a, _0x394ba2) {
				return _0xc12a3c[_0x5c3d('382', 'n@nG')](_0x77e22a, _0x394ba2);
			},
			'JaNEQ': _0xc12a3c['hsAMY'],
			'NhTNy': _0xc12a3c[_0x5c3d('383', 'wc[h')],
			'jHGgI': _0xc12a3c[_0x5c3d('384', 'm0Q1')],
		...
		const _0x1f09e6 = {
			...
			'timeout': 0x2710,
			'headers': {
				'User-Agent': _0xc12a3c[_0x5c3d('385', 'J(]D')]
			}
		};
		if ($[_0x5c3d('386', 'qi!x')]() && process[_0x5c3d('387', '8ye]')][_0x5c3d('388', 'QeIx')] && process['env'][_0x5c3d('389', '#g!5')]) {
			const _0x317df7 = _0xc12a3c[_0x5c3d('38a', 'n@nG')](require, _0xc12a3c[_0x5c3d('38b', 's2t@')]);
			const _0xe378a3 = {
				'https': _0x317df7[_0x5c3d('38c', '#g!5')]({
					'proxy': {
						'host': process[_0x5c3d('38d', '$lyO')][_0x5c3d('38e', 'DI]G')],
						'port': _0xc12a3c[_0x5c3d('38f', 'GEp&')](process[_0x5c3d('390', 'n@nG')][_0x5c3d('391', 'pqb(')], 0x1)
					}
				})
			};
			Object[_0x5c3d('392', 'qt1B')](_0x1f09e6, {
				'agent': _0xe378a3
			});
		}
		$[_0x5c3d('393', 'o7vD')](_0x1f09e6, async(_0x3bd83, _0xe91b83, _0x4b5727) = > {
			if (_0x369d0e[_0x5c3d('394', 'QeIx')](_0x369d0e[_0x5c3d('395', ']loZ')], _0x5c3d('396', 'qt1B'))) {
				if (_0x3bd83) {
					console[_0x5c3d('17a', 'KKA&')]('
' + $['name'] + _0x5c3d('397', 'm)@n'));
					console['log'](JSON[_0x5c3d('a9', '7De#')](_0x3bd83));
				} else {
					_0x4b5727 = JSON[_0x5c3d('398', 'KKA&')](_0x4b5727);
				}
			} else {
				try {
					if (_0x3bd83) {} else {
						if (_0x369d0e[_0x5c3d('399', 'pqb(')] === _0x369d0e['jHGgI']) {
							if (_0x3bd83) {
								console[_0x5c3d('2c4', 'f$@p')]('
' + $[_0x5c3d('39a', 'NJq]')] + _0x5c3d('39b', 'o%Hs'));
								console['log'](JSON[_0x5c3d('248', 'QeIx')](_0x3bd83));
							} else {
								console[_0x5c3d('202', 'Vm#Z')](_0x5c3d('39c', ']G5@') + _0x4b5727);
					...
					if (_0x369d0e['aSZoh'](_0x369d0e[_0x5c3d('39d', 'NJq]')], _0x369d0e[_0x5c3d('39e', 'QeIx')])) {
						$[_0x5c3d('39f', '(S7p')](e, _0xe91b83);
					} else {
						_0xa212ba(_0x4b5727);
					}
				}
