...
[task_local]
#家电星推官
0 0 18 * * * jd_xtg.js, tag=家电星推官, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "0 0 18 * * *" script-path=jd_xtg.js,tag=家电星推官

===============Surge=================
家电星推官 = type=cron,cronexp="0 0 18 * * *",wake-system=1,timeout=3600,script-path=jd_xtg.js
