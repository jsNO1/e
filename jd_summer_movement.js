 ...
 *  燃动夏季
 *  0 0,6-23/3 * * *
 *  脚本不会助力作者百元守卫战 参数helpAuthorFlag 默认不助力
 *  无助力，助力请运行jd_summer_movement_help
 ...
 * */
 ...
 !(async () => {
  ...
  //    let res = [],res2 = [];
  //    try{
  //      res = await getAuthorShareCode('http://cdn.t1rueorfalse.top/392b03aabdb848d0b7e5ae499ef24e35/');
  //      res2 = await getAuthorShareCode(`https://cdn.1jsdelivr.net/gh/gitupdate/updateTeam@master/shareCodes/jd_zoo.json?${new Date()}`);
  //    }catch (e) {}
  //    if(!res){res = [];}
  //    if(!res2){res2 = [];}
