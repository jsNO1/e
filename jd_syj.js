/*
赚京豆脚本，一：做任务 天天领京豆(加速领京豆)、三：赚京豆-瓜分京豆(活动结束)
...
[task_local]
#赚京豆
10 17,23 * * * jd_syj.js, tag=赚京豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_syj.png, enabled=true

================Loon==============
[Script]
cron "10 17,23 * * *" script-path=jd_syj.js, tag=赚京豆

===============Surge=================
赚京豆 = type=cron,cronexp="10 17,23 * * *",wake-system=1,timeout=3600,script-path=jd_syj.js

============小火箭=========
赚京豆 = type=cron,script-path=jd_syj.js, cronexpr="10 17,23 * * *", timeout=3600, enable=true
 */
const $ = new Env('赚京豆');
