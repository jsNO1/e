...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/jsNO1/e/main/code/goldPhone.json');}catch (e) {}
    // if(!res){
    //     try{res = await getAuthorShareCode('https://gitee.com/jsNO1/share-code/raw/master/goldPhone.json');}catch (e) {}
    //     if(!res){res = [];}
    // }
    if(res && res.length > 0){
