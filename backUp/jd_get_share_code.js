...
let shareCodedd= '', shareCodejx= '', shareCodefr= '', shareCodepb= '', shareCodeca= '', shareCodepe= '', shareCodesm= '', pijjie= '@';
              ...
              if (data.data.bizCode === 0) {
                ...
                $.taskVos.map((item) => {
                  if (item.taskType === 14) {
                    ...
                    $.taskCode= item.assistTaskDetailVo.taskToken;
                    //console.log(`【东东工厂1】${shareCodedd}`);
                    shareCodedd = shareCodedd.concat($.taskCode);
                    shareCodedd = shareCodedd.concat(pijjie);
                    //console.log($.taskCode);
                    console.log(`【东东工厂助力码添加成功】`);
                  }
                });
              }
            }
            ...
            if (safeGet(data)) {
              ...
              if (data["ret"] === 0) {
                ...
                if (data.factoryList && data.productionList) {
                 ...
                 // console.log(`【京喜工厂1】${shareCodejx}`);
                  shareCodejx = shareCodejx.concat($.encryptPin);
                  shareCodejx = shareCodejx.concat(pijjie);
                  //console.log($.encryptPin);
                  console.log(`【京喜工厂助力码添加成功】`);
                }
              } else {
      ...
      try {
        if (err) {
          ...
          if (
            ...
            //console.log(`【京东萌宠1】${shareCodepe}`);
            shareCodepe = shareCodepe.concat($.petcode);
            shareCodepe = shareCodepe.concat(pijjie);
            //console.log($.petcode);
            console.log(`【京东萌宠助力码添加成功】`);
...
async function getPlantBean() {
  ...
  async function jdPlantBean() {
    ...
    if ($.plantBeanIndexResult.code === "0") {
      ...
      //console.log(`【种豆得豆1】${shareCodepb}`);
      shareCodepb = shareCodepb.concat(pijjie)
      shareCodepb = shareCodepb.concat($.myPlantUuid);
      //console.log($.myPlantUuid);
      console.log(`【种豆得豆助力码添加成功】`);
    } else {
      console.log(
...
async function getJDFruit() {
  ...
  async function jdFruit() {
    ...
    if ($.farmInfo.farmUserPro) {
      ...
      $.fruitcode=$.farmInfo.farmUserPro.shareCode;
      //console.log(`【京东农场1】${$.fruitcode}`);
      shareCodefr = shareCodefr.concat($.fruitcode);
      shareCodefr = shareCodefr.concat(pijjie);
      //console.log(petcode);
      console.log(`【京东农场助力码添加成功】`);
    } else {
      /*console.log(
      ...
      $.post(url, async (err, resp, data) => {
        try {
          ...
          if (data.data.bizCode === 0) {
            ...
            $.smcode=invites[0]['assistTaskDetailVo']['taskToken'];
            //console.log(`【京东盒子1】${$.smcode}`);
            shareCodesm = shareCodesm.concat($.smcode);
            shareCodesm = shareCodesm.concat(pijjie);
            //console.log($.smcode);
            console.log(`【京东盒子助力码添加成功】`);
          }
        } catch (e) {
          $.logErr(e, resp);
        } finally {
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if(data.code===0 && data.data.result){
              ...
              $.cacode=data.data.result.inviteCode
              //console.log(`【签到领现金1】${$.cacode}`);
              shareCodeca = shareCodeca.concat($.cacode);
              shareCodeca = shareCodeca.concat(pijjie);
              //console.log($.cacode);
              console.log(`【签到领现金助力码添加成功】`);
            }
          }
        }
      } catch (e) {
...
async function getShareCode() {
  ...
  await getJdCash()
  console.log(`======京东工厂======`)
  console.log(shareCodedd)
  console.log(`======京喜工厂======`)
  console.log(shareCodejx)
  console.log(`======京东水果======`)
  console.log(shareCodefr)
  console.log(`======京东种豆======`)
  console.log(shareCodepb)
  console.log(`======京东现金======`)
  console.log(shareCodeca)
  console.log(`======京东萌宠======`)
  console.log(shareCodepe)
  console.log(`======京东盲盒======`)
  console.log(shareCodesm)
