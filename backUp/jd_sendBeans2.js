...
[task_local]
#送豆得豆
10 0,8 * * * jd_sendBeans2.js.js, tag=送豆得豆, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
* */
const $ = new Env('送豆得豆');
...
async function getActivityList(){
  return new Promise((resolve) => {
    let options = {
      "url": `https://draw.jdfcloud.com/common/api/bean/activity/list/activity/by/channel?openId=&channelId=0&channelType=HOME&sendType=0&appId=&invokeKey=qRKHmL4sna8ZOP9F`,
      "headers": {
        ...
        "Referer": "https://servicewechat.com/wxccb5c536b0ecd1bf/738/page-frame.html",
