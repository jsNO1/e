...
[task_local]
#东东萌宠互助
15 0 * * * jd_pet.js, tag=东东萌宠, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdmc.png, enabled=true

=================================Loon===================================
[Script]
cron "15 0 * * *" script-path=jd_pet.js,tag=东东萌宠互助

===================================Surge================================
东东萌宠互助 = type=cron,cronexp="15 0 * * *",wake-system=1,timeout=3600,script-path=jd_pet.js

====================================小火箭=============================
东东萌宠互助 = type=cron,script-path=jd_pet.js, cronexpr="15 0 * * *", timeout=3600, enable=true
