...
[task_local]
#愤怒的锦鲤
0 0 0 * * *  jd_redPacket.js, tag=愤怒的锦鲤, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_redPacket.png, enabled=true
===================Loon==============
[Script]
cron "0 0 0 * * * " script-path=jd_redPacket.js, tag=愤怒的锦鲤
===============Surge===============
[Script]
愤怒的锦鲤 = type=cron,cronexp="0 0 0 * * * ",wake-system=1,timeout=3600,script-path=jd_redPacket.js
====================================小火箭=============================
愤怒的锦鲤 = type=cron,script-path=jd_redPacket.js, cronexpr="0 0 0 * * * ", timeout=3600, enable=true
愤怒的锦鲤
更新时间：2021-7-11
