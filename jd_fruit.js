...
=========================Loon=============================
[Script]
cron "5 7-18/6 * * *" script-path=jd_fruit.js,tag=东东农场

=========================Surge============================
东东农场 = type=cron,cronexp="5 7-18/6 * * *",wake-system=1,timeout=3600,script-path=jd_fruit.js

=========================小火箭===========================
东东农场 = type=cron,script-path=jd_fruit.js, cronexpr="5 7-18/6 * * *", timeout=3600, enable=true
...
const retainWater = 10000000; //保留水滴大于多少g,默认100g;
