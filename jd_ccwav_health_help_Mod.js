...
[task_local]
#东东健康社区互助
13 2 * * * jd_health.js, tag=东东健康社区, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "13 2 * * *" script-path=jd_health.js, tag=东东健康社区互助

====================Surge================
东东健康社区互助 = type=cron,cronexp="13 2 * * *",wake-system=1,timeout=3600,script-path=jd_health.js

============小火箭=========
东东健康社区互助 = type=cron,script-path=jd_health.js, cronexpr="13 2 * * *", timeout=3600, enable=true
 */
