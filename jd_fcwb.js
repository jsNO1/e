...
[task_local]
#发财挖宝
20 7,12,16 * * * https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_fcwb.js, tag=发财挖宝, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "20 1,9,16 * * *" script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_fcwb.js,tag=发财挖宝

===============Surge=================
发财挖宝 = type=cron,cronexp="20 1,9,16 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/main/jd_fcwb.js

============小火箭=========
发财挖宝 = type=cron,script-path=https://raw.githubusercontent.com/yongyuanlin/jd_scripts/master/jd_fcwb.js, cronexpr="20 1,9,16 * * *", timeout=3600, enable=true
 */
const $ = new Env('发财挖宝');
...
!(async () => {
    ...
    let res = [];
    // try{res = await getAuthorShareCode('https://raw.githubusercontent.com/yongyuanlin/cast/main/mast/fcwb.json');}catch (e) {}
    // if(!res){
    //     try{res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/yongyuanlin/cast@main/mast/fcwb.json');}catch (e) {}
    //     if(!res){res = [];}
    // }
    // if(res.length > 0){
