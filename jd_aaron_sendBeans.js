...
[task_local]
#送豆得豆
0 0 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_aaron_sendBeans.js, tag=送豆得豆, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "0 0 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_aaron_sendBeans.js,tag=送豆得豆
===============Surge=================
送豆得豆 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_aaron_sendBeans.js
============小火箭=========
送豆得豆 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_aaron_sendBeans.js, cronexpr="0 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('送豆得豆');
