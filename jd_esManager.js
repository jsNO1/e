...
[task_local]
#东东电竞经理
13 1,12,23 * * * jd_esManager.js, tag=东东电竞经理, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "13 1,12,23 * * *" script-path=jd_esManager.js, tag=东东电竞经理

====================Surge================
东东电竞经理 = type=cron,cronexp="13 1,12,23 * * *",wake-system=1,timeout=3600,script-path=jd_esManager.js

============小火箭=========
东东电竞经理 = type=cron,script-path=jd_esManager.js, cronexpr="13 1,12,23 * * *", timeout=3600, enable=true
*/
